                    ...
                    child: Column(
                      ...
                      children: [
                        const SizedBox(height: 140,),
                           Padding(
                            padding:const EdgeInsets.symmetric(horizontal: 34.0,vertical: 32),
                            child: Text(AppStrings.register.trr(context),style: MyTextStyles.hOneTextStyle,),
                          ),
                          ...
                          Padding(
                            ...
                            child: MyTextField(controller: controller.nameController,
                              ...
                              label: AppStrings.name.trr(context),),
                          ),
                        Padding(
                          padding: const EdgeInsets.symmetric(horizontal: 34,vertical: 8),
                        ...
                        Padding(
                          ...
                          child: MyButton(text: AppStrings.signUp.trr(context), withArrow: false,
                        ...
                        Row (
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                             Text(AppStrings.alreadyHaveAccount.trr(context),style: const TextStyle(color: Colors.white),),
                            TextButton(onPressed: (){
                              Get.off(()=> LoginPage());
                            }, child:  Text(AppStrings.signIn.trr(context),style: const TextStyle(color: MyColors.primaryColor))),
                          ],
                        )
                      ],
                    ),
